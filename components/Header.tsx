...
import { MagnifyingGlassIcon, BellIcon, CogIcon, UserCircleIcon, ChevronDownIcon } from './icons/Icons.tsx';
    ...
    <header className="bg-card flex-shrink-0 flex items-center justify-between px-6 py-3">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-popover rounded-md shadow-lg ring-1 ring-border py-1">
