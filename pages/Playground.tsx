...
type PlaygroundTab = 'fast-chat' | 'voice-chat' | 'chat' | 'image-generation' | 'image-editing' | 'image-analysis' | 'image-to-video' | 'text-to-video' | 'audio-transcription' | 'text-to-speech' | 'grounded-search' | 'complex-reasoning';
...
const TABS: { id: PlaygroundTab; label: string; icon: React.ElementType; component: React.ElementType }[] = [
  ...
  { id: 'image-to-video', label: 'Image-to-Video', icon: VideoCameraIcon, component: VideoGenerator },
